...
class Screenshot(object):
                    ...
                    if (x, y-1) in coord2item:
                        ...
                        if itemA:
                            ...
                            if itemB != itemA:
                                ...
                                for ax in range(itemA._bbox[0], itemA._bbox[2]+1):
                                    for ay in range(itemA._bbox[1], itemA._bbox[3]+1):
    ...
    def getColor(self, xy_coords):
        """
        Return pixel color at coordinates

        Parameters:

          xy_coords (pair of integers or floats):
    ...
    def close(self):
        if self._outFileObj != None:
            ...
            if self._bytesToFile > 0:
                for c in range(len(self._callStack)):
